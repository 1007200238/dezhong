...
<form action="<?php echo U('Psi/apply_edit');?>" method="POST" id="list" class="form-horizontal">
	<!-- 标题栏 -->
	...
	<div class="cf">
		<div class="fl">
            ...
            <input name="department" type="text" class="text input-small" value="<?php echo ($_list["department"]); ?>">&nbsp;&nbsp;&nbsp;
            <span style="font-weight:bold;">申购单编号：</span>
            <input name="no" type="text" class="text" value="<?php echo ($_list["no"]); ?>">&nbsp;&nbsp;&nbsp;
	    ...
	    <tbody>
			<?php if(!empty($_list)): if(is_array($_list["info"])): $i = 0; $__LIST__ = $_list["info"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(!empty($vo["code"])): ?><tr>
					...
					<td><input name="list[<?php echo ($i); ?>][num]" type="number" value="<?php echo ($vo["num"]); ?>" style="width:50px;"></td>
					<td><?php echo ($vo["unit"]); ?></td>
					<td><input name="list[<?php echo ($i); ?>][date]" type="text" class="text time" placeholder="请选择时间" value="<?php echo (date('Y-m-d H:i',$vo["date"])); ?>"/></td>
					<td><input type="text" name="list[<?php echo ($i); ?>][note]" class="text" placeholder="商品备注" value="<?php echo ($vo["note"]); ?>"/></td>
					<input type="hidden" name="list[<?php echo ($i); ?>][id]" value="<?php echo ($vo["id"]); ?>" />
		...
		<div class="fb">
			...
			<input name="dpt_man" type="text" class="text input-small" value="<?php echo ($_list["dpt_man"]); ?>">&nbsp;&nbsp;&nbsp;
			<span style="font-weight:bold;">采购部门（人）：</span>
			<input name="pch_man" type="text" class="text input-small" value="<?php echo ($_list["pch_man"]); ?>">&nbsp;&nbsp;&nbsp;
			<span style="font-weight:bold;">审核：</span>
			<input name="ver_man" type="text" class="text input-small" value="<?php echo ($_list["ver_man"]); ?>">&nbsp;&nbsp;&nbsp;
