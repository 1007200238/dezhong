...
<style>
	...
	<div class="cf">
		<div class="fl">
			<a class="btn" href="<?php echo U('Psi/return_info');?>&id=<?php echo I('get.id');?>&print=1" target="_blank" >打印单据</a>
			<span>退货单编号：</span>
            <?php echo ($_list["no"]); ?>&nbsp;&nbsp;&nbsp;
            <span>关联单编号：</span>
        ...
        <div class="fr">
            <span>退货日期：</span>
            <?php echo (date('Y-m-d',$_list["date"])); ?>&nbsp;&nbsp;&nbsp;
            <span>操作时间：</span>
            <?php echo (date('Y-m-d',$_list["time"])); ?>&nbsp;&nbsp;&nbsp;
            <span>操作员：</span>
    ...
    <div class="data-table table-striped">
	    ...
	    <tbody>
			...
			<tr>
				...
				<td> —— </td>
				<td> —— </td>
				<td><span style="font-weight:bold;"><?php echo ($sum); ?></span></td>
				<td><span style="font-weight:bold;"><?php echo ($total); ?></span></td>
			</tr>
			<tr>
	    ...
	    <div class="fl" style="float:right !important;">
			<span>开票：</span>
			<?php echo ($_list["info1"]); if(empty($_list["info1"])): ?>暂无<?php endif; ?>&nbsp;&nbsp;&nbsp;
			<span>审核：</span>
			<?php echo ($_list["info2"]); if(empty($_list["info2"])): ?>暂无<?php endif; ?>&nbsp;&nbsp;&nbsp;
			<span>退货类型：</span>
			<?php echo (get_status_type($_list["from"],"returned")); ?>
				        ...
				        <div class="hd cf">
	       				...
	       				<div class="bd" style="height:auto;"><div class="sys-info">
	            			<table><tbody>
				                <tr>
				                    <th>单位名称（章）</th>
				                    <td><?php echo ($_list["pinfo"]["company"]); ?></td>
				                </tr>
				                <tr>
				                    <th>单位地址</th>
				                    <td><?php echo ($_list["pinfo"]["address"]); ?></td>
				                </tr>
				                <tr>
				                    <th>法定代表人</th>
				                    <td><?php echo ($_list["pinfo"]["name"]); ?></td>
				                </tr>
				                <tr>
				                    <th>委托代理人</th>
				                    <td><?php echo ($_list["pinfo"]["consigner"]); ?></td>
				                </tr>
				                <tr>
				                    <th>电话</th>
				                    <td><?php echo ($_list["pinfo"]["mobile"]); ?></td>
				                </tr>
				                <tr>
				                    <th>传真</th>
				                    <td><?php echo ($_list["pinfo"]["fax"]); ?></td>
				                </tr>
	            			</tbody></table>
	        			</div></div>
        			<?php } else { ?>
						<div class="hd cf">
	       				...
	       				<div class="bd" style="height:auto;"><div class="sys-info">
	            			<table><tbody>
				                ...
				                <tr>
				                    <th>联系人</th>
				                    <td><?php echo ($_list["pinfo"]["truename"]); ?></td>
				                </tr>
				                <tr>
				                    <th>电话</th>
				                    <td><?php echo ($_list["pinfo"]["mobile"]); ?></td>
	...
	<script type="text/javascript">
	    //导航高亮
	    highlight_subnav('<?php echo U('Psi/return_list');?>');
	</script>
