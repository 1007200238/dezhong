...
<body>
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <select name="type">
                    ...
                    <option value="1" <?php if($info['type']=='1'){ ?> selected <?php } ?>>固定属性</option>   
			        <option value="2" <?php if($info['type']=='2'){ ?> selected <?php } ?>>非固定属性</option>
            	</select>
            </div>
        </div>
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input" name="price" value="<?php echo ($info["price"]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">包装品备注<span class="check-tips">（100字以内，选填）</span></label>
            <div class="controls">
                <textarea name="note" class="textarea" cols="54" rows="6"><?php echo ($info["note"]); ?></textarea>
            </div>
        </div>
        <div class="tips">
    ...
    <script type="text/javascript">
        //导航高亮
        highlight_subnav('<?php echo U('Psi/exstock');?>');
    </script>
