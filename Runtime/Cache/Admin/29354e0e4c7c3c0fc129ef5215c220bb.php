...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="no" value="">
            </div>
        </div>        
        <div class="form-item">
            <label class="item-label">供应商名称<span class="check-tips">（15字以内）</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="company" value="">
            </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="consigner" value="">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">委托代表人电话<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="consigner_mobile" value="">
            </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="fax" value="">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">开户银行<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="bank" value="">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">开户人<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="account_user" value="">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">开户账号<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="account" value="">
            </div>
        </div>
        <div class="form-item">
    ...
    <script type="text/javascript">
        //导航高亮
        highlight_subnav('<?php echo U('Psi/supplier_add');?>');
    </script>
