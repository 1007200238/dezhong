...
<style>
	...
	<div class="cf">
		<div class="fl">
			...
			<a href="<?php echo U('Psi/contract_list');?>&export=1" class="btn">导出Excel</a>
        </div>
        <!-- 高级搜索 -->
		<div class="search-form fr cf">
			<div class="fl">
				<div class="controls">
                    <select name="status" class="change" id="status" onchange="gourl('status');">
	                    ...
	                    <?php if(is_array($_status)): $i = 0; $__LIST__ = $_status;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($i); ?>" <?php if(I('status')==$i){ ?> selected <?php } ?> ><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>                    
                </div>
			</div>
			<div class="fl">
			...
			<div class="sleft">
				<div class="drop-down">
					<span id="sch-sort-txt" class="sort-txt" data="<?php echo ($type); ?>"><?php if(I('type') == ''): ?>供应商名称<?php else: echo get_status_type($type); endif; ?></span>
				...
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Psi/contract_list');?>"><i class="btn-search"></i></a>
			</div>
	    ...
	    <tbody>
			<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
	            ...
	            <td><a href="<?php echo U('Psi/contract_info');?>&id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["no"]); ?></a></td>
				<td><?php echo (get_company($vo["supplier"])); ?></td>
				<td><?php echo ($vo["total"]); ?></td>
				<td><?php echo ($vo["num"]); ?></td>
				<td><?php echo (date("Y-m-d H:i",$vo["pch_date"])); ?></td>
				<td><?php echo (date("Y-m-d H:i",$vo["dev_date"])); ?></td>
				<td><?php echo (get_status_type($vo["status"],"contract")); ?></td>
				<td>
					<a href="<?php echo U('Psi/contract_info');?>&id=<?php echo ($vo["id"]); ?>">详情</a> | 
					<a href="<?php echo U('Psi/contract_edit');?>&id=<?php echo ($vo["id"]); ?>">更改状态</a> | 
					<?php if ($vo['status'] < 4) { ?>
						<a href="<?php echo U('Psi/in_return');?>&id=<?php echo ($vo["id"]); ?>">退货</a> |
					<?php } ?>
					<a href="<?php echo U('Psi/contract_del');?>&id=<?php echo ($vo["id"]); ?>" class="confirm ajax-get">删除</a>
				</td>
