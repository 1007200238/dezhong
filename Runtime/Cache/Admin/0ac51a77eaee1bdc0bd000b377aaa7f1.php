...
<body>
		...
		<div class="search-form">
			<div class="sleft">
				<form action="<?php echo U();?>" method="post" class="form-horizontal">
					<input type="text" name="code" class="search-input" value="" placeholder="请输入出库商品的编号代码">
					<button class="btn ajax-post" id="submit" type="submit" target-form="form-horizontal" style="background-color: rgb(56, 56, 56); margin: 1px 1px 0 0; color:#F6F6F6">添入本期出库列表</button>
				</form>
			</div>
		</div>
		<div class="search-form fr cf" style="float:left">
			<div class="sleft">
				<a class="btn" href="<?php echo U('Psi/free_do');?>">提交退货单</a>
			</div>
		</div>
    </div>
    <!-- 数据列表 -->
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td><a href="<?php echo U('Psi/free_return');?>&sid=<?php echo ($vo["id"]); ?>" class="ajax-get">清除</a></td>
