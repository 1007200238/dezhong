...
<style>
	...
	<div class="main-title">
		...
		<h2>退货单列表&nbsp;&nbsp;<?php echo (get_status_type($_style,'returned')); ?></h2>
	</div>
	<div class="cf">
        <!-- 高级搜索 -->
		<div class="search-form fr cf">
			<div class="sleft">
				<div class="drop-down">
					<span id="sch-sort-txt" class="sort-txt" data="<?php echo ($type); ?>"><?php if(I('type') == ''): ?>退货单编号<?php else: echo get_status_type($type); endif; ?></span>
				...
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Psi/return_list');?>"><i class="btn-search"></i></a>
			</div>
	    ...
	    <tbody>
			<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
	            ...
	            <td><?php echo (get_status_type($vo["from"],"returned")); ?></td>
	            <td><a href="<?php echo U('Psi/return_info');?>&id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["no"]); ?></a></td>
				<td><?php echo ($vo["from_no"]); ?></td>
				<td><?php echo (get_company($vo["pid"],$vo['from'])); ?></td>
				<td><?php echo (date("Y-m-d H:i",$vo["date"])); ?></td>
				<td><?php echo ($vo["info1"]); ?></td>
				<td><?php echo ($vo["info2"]); ?></td>
				<td>
					<a href="<?php echo U('Psi/return_info');?>&id=<?php echo ($vo["id"]); ?>">单据详情</a>
				</td>
...
$(function(){
	...
	$("#search").click(function(){
        ...
        url += '&ask=1&style=<?php echo ($_style); ?>';
