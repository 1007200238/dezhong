...
<style>
	...
	<div class="cf">
		<div class="fl">
			<a class="btn" href="<?php echo U('Psi/in_info');?>&id=<?php echo I('get.id');?>&print=1" target="_blank" >打印单据</a>
    ...
    <div class="data-table table-striped">
	    ...
	    <tbody>
			...
			<tr>
				...
				<td colspan="6"><?php echo ($_list["note"]); if(empty($_list["note"])): ?>暂无<?php endif; ?></td>
			</tr>
			<?php else: ?>
	    ...
	    <div class="fl" style="float:right !important;">
			...
			<?php echo ($_list["supplier"]["company"]); ?>
	    </div>
	...
	<script type="text/javascript">
	    //导航高亮
	    highlight_subnav('<?php echo U('Psi/in_list');?>');
	</script>
