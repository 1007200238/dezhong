...
<body>
	...
	<div class="cf">
		<div class="fl">
            <a class="btn" href="<?php echo U('Psi/exstock_add');?>">新 增</a>
            <button class="btn ajax-post confirm" url="<?php echo U('Psi/exstock_del');?>" target-form="ids">删 除</button>
        </div>
    </div>
    <!-- 数据列表 -->
    ...
    <thead>
		...
		<th class="" width="15%">包装品名称</th>
		<th class="" width="10%">是否固定</th>
		<th class="" width="10%">价格(元)</th>
		<th class="" width="10%">库存量</th>
		<th class="" width="">备注</th>
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><a href="<?php echo U('Psi/exstock_info');?>&id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></a></td>
			<td><?php echo (get_status_type($vo["type"],'exstock')); ?></td>
			<td><?php echo ($vo["price"]); ?></td>
			<td><?php echo ($vo["num"]); ?></td>
			<td><?php echo ($vo["note"]); ?></td>
			<td> 
				<a href="<?php echo U('Psi/exstock_in');?>&id=<?php echo ($vo["id"]); ?>">入库</a> |
				<a href="<?php echo U('Psi/exstock_info');?>&id=<?php echo ($vo["id"]); ?>">详情</a> | 
				<a href="<?php echo U('Psi/exstock_edit');?>&id=<?php echo ($vo["id"]); ?>">修改</a> | 
				<a href="<?php echo U('Psi/exstock_del?id='.$vo['id']);?>" class="confirm ajax-get">删除</a>
			</td>
