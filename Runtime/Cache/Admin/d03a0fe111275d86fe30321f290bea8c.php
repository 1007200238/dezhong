...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        <div class="form-item">
            <label class="item-label">最小预警量<span class="check-tips">（0为不限制）</span></label>
            <div class="controls">
                <input type="text" name="min_num" class="text" value="<?php echo ($_min_num); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">最大预警量<span class="check-tips">（0为不限制）</span></label>
            <div class="controls">
                <input type="text" name="max_num" class="text" value="<?php echo ($_max_num); ?>">
            </div>
        </div>
        <input type="hidden" name="ids" value="<?php echo ($_ids); ?>">
        <div class="form-item">
    ...
    <div class="fb">
        <span style="color:grey">友情提示：批量编辑将会使勾选的产品统一设置成相同的预警值！</span>
    </div> 
    ...
    <script type="text/javascript">
        //导航高亮
        highlight_subnav('<?php echo U('Psi/inventory');?>');
    </script>
