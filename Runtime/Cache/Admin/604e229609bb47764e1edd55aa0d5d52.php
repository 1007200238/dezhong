...
<body>
	...
	<div class="cf">
		...
		<div class="search-form fr cf" style="float:left">
			<div class="sleft">
				<input type="text" name="code" class="search-input" value="<?php echo I('code');?>" placeholder="请输入查询产品的编号代码">
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('record');?>"><i class="btn-search"></i></a>
			</div>
		</div>
    </div>
    <!-- 数据列表 -->
    ...
    <thead>
		...
		<?php if(is_array($_th)): $i = 0; $__LIST__ = $_th;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><th class=""><?php echo ($vo); ?></th><?php endforeach; endif; else: echo "" ;endif; ?>	
		</tr>
    </thead>
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><?php echo (get_status_type($vo["type"],"record")); ?></td>
    ...
    <div class="fb">
		<span style="color:#999">友情提示：这里展示的是所有商品出入库单条记录。</span>
	</div> 
	...
	<script type="text/javascript">
    //导航高亮
    highlight_subnav('<?php echo U('Psi/exstock_record');?>');
	</script>
