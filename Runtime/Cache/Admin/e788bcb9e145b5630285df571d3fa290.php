...
<style>
	...
	<div class="cf">
		<div class="fl">
			<a class="btn" href="<?php echo U('Psi/order_info');?>&id=<?php echo I('get.id');?>&print=1" target="_blank" >打印单据</a>
			<span>订单编号：</span>
    ...
    <div class="data-table table-striped">
	    ...
	    <tbody>
			...
			<tr>
				...
				<td colspan="7">
					<?php if(!empty($info["process"])): if(is_array($info["process"])): $i = 0; $__LIST__ = $info["process"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$va): $mod = ($i % 2 );++$i;?><div style="line-height:32px">
							<div style="float:left; margin-right:12px"><?php echo ($va["date"]); ?></div>
							<div style="float:left; margin-right:12px"><?php echo (get_status_type($va["status"],"order")); ?></div>
							<div style="float:left; margin-right:12px"><?php echo ($va["username"]); ?></div>
							<div style="float:left"><?php echo ($va["process"]); ?></div>
			...
			<tr>
				...
				<td colspan="7"><?php echo ($info["note"]); ?></td>
			</tr>
			<?php else: ?>
