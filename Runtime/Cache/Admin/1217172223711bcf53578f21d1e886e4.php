    ...
    <div class="data-table table-striped">
	    ...
	    <tbody>
			<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td>
					<a href="<?php echo U('Psi/order_info');?>&id=<?php echo ($vo["id"]); ?>">订单详情</a> | 
					<?php if ($vo['status'] > 2) { ?>
						<a href="<?php echo U('Psi/order_process');?>&id=<?php echo ($vo["id"]); ?>">追踪流程</a>
					<?php } else { ?> 
						<a href="<?php echo U('Psi/out_do');?>&id=<?php echo ($vo["id"]); ?>">出库</a>
					<?php } ?>
				</td>
