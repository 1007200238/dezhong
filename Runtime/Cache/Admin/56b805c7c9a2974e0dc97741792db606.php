...
<body>
	...
	<div class="cf">
		<div class="fl">
            <a class="btn" href="<?php echo U('Psi/supplier_add');?>">新 增</a>
            <button class="btn ajax-post confirm" url="<?php echo U('Psi/supplier_del');?>" target-form="ids">删 除</button>
        </div>
		<div class="search-form fr cf">
			<div class="sleft">
				<div class="drop-down">
					<span id="sch-sort-txt" class="sort-txt" data="<?php echo ($type); ?>"><?php if(I('type') == ''): ?>供应商名<?php else: echo get_status_type($type); endif; ?></span>
				...
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Psi/supplier');?>"><i class="btn-search"></i></a>
			</div>
		</div>
    </div>
    <!-- 数据列表 -->
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><?php echo ($vo["consigner"]); ?>&nbsp;<?php echo ($vo["consigner_mobile"]); ?></td>
			<td><?php echo ($vo["fax"]); ?></td>
			<td><?php echo ($vo["account"]); ?></td>
			<td><?php echo ($vo["no"]); ?></td>
			<td>
				<a href="<?php echo U('Psi/stock');?>&supplier=<?php echo ($vo["id"]); ?>">产品浏览</a> | 
				<a href="<?php echo U('Psi/supplier_info');?>&id=<?php echo ($vo["id"]); ?>">详细资料</a> |
				<a href="<?php echo U('Psi/supplier_edit');?>&id=<?php echo ($vo["id"]); ?>">修改</a> | 
				<a href="<?php echo U('Psi/supplier_del?id='.$vo['id']);?>" class="confirm ajax-get">删除</a>
			</td>
