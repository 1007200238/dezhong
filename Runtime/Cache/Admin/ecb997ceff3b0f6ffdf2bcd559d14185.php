...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <select name="status" id="status">
                    ...
                    <?php if(is_array($_status["list"])): $k = 0; $__LIST__ = $_status["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$va): $mod = ($k % 2 );++$k;?><option value="<?php echo ($k); ?>" <?php if($k==$_status['now']){ ?>selected<?php } ?> ><?php echo ($va); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>   
                </select>
            </div>
        </div>        
        <div class="form-item">
        ...
        <input type="hidden" name="oid" value="<?php echo ($_id); ?>">
        <div class="form-item">
