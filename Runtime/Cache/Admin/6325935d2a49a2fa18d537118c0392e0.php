...
<style>
	...
	<div class="cf">
		<div class="fl">
			<a class="btn" href="<?php echo U('Psi/contract_info');?>&id=<?php echo I('get.id');?>&print=1" target="_blank" >打印单据</a>
			<a href="<?php echo U('Psi/contract_info');?>&id=<?php echo I('get.id');?>&export=1" class="btn">导出Excel</a>
			<span style="font-weight:bold;">合同编号：</span>
            <?php echo ($_list["no"]); ?>&nbsp;&nbsp;&nbsp;
            <span style="font-weight:bold;">合同状态：</span>
			<?php echo (get_status_type($_list["status"],"contract")); ?>&nbsp;&nbsp;&nbsp;
        </div>
        <div class="fr">
            <span style="font-weight:bold;">采购日期：</span>
            <?php echo (date('Y-m-d H:i',$_list["pch_date"])); ?>&nbsp;&nbsp;&nbsp;
            <span style="font-weight:bold;">交货日期：</span>
            <?php echo (date('Y-m-d H:i',$_list["dev_date"])); ?>&nbsp;&nbsp;&nbsp;
        </div>
    </div>
	    <!-- 数据列表 -->
    <div class="data-table table-striped">
	    ...
	    <tbody>
			<?php if(!empty($_list)): if(is_array($_list["info"])): $i = 0; $__LIST__ = $_list["info"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(!empty($vo["code"])): ?><tr>
				...
				<?php $total2 += $t2; endforeach; endif; else: echo "" ;endif; ?>
			<tr>
			        ...
			        <div class="hd cf">
       				...
       				<div class="bd" style="height:auto;"><div class="sys-info">
            			<table><tbody>
			                ...
			                <tr>
			                    <th>开户银行</th>
			                    <td><?php echo ($_list["supplier"]["bank"]); ?></td>
			                </tr>
			                <tr>
			                    <th>账号</th>
			                    <td><?php echo ($_list["supplier"]["account"]); ?></td>
			                </tr>	
            			</tbody></table>
        			</div></div>
    			</div>				
