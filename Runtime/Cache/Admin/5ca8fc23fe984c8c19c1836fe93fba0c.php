...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        <div class="form-item">
            <label class="item-label">供应商名称<span class="check-tips"></span></label>
            <div class="controls"><?php echo (get_company($info["supplier_id"])); ?></div>
        </div>        
        <div class="form-item">
            <label class="item-label">明细日期<span class="check-tips">（15字以内）</span></label>
            <div class="controls"><?php echo (date("Y-m-d",$info["date"])); ?></div>
        </div>
        <div class="form-item">
            <label class="item-label">摘要<span class="check-tips">（50字以内）</span></label>
            <div class="controls"><?php echo ($info["intro"]); ?></div>
        </div>
        <div class="form-item">
            <label class="item-label">借方<span class="check-tips">付款</span></label>
            <div class="controls"><?php echo ($info["debit"]); ?></div>
        </div>
        <div class="form-item">
            <label class="item-label">贷方<span class="check-tips">收货</span></label>
            <div class="controls"><?php echo ($info["credit"]); ?></div>
        </div>
        <div class="form-item">
            <label class="item-label">余额<span class="check-tips"></span></label>
            <div class="controls"><?php echo ($info["balance"]); ?></div>
        </div>
        <div class="form-item">
            <label class="item-label">备注<span class="check-tips">（50字以内）</span></label>
            <div class="controls"><?php echo ($info["note"]); ?></div>
        </div>
        <div class="form-item">
    ...
    <script type="text/javascript">
        //导航高亮
        highlight_subnav('<?php echo U('Psi/account');?>');
    </script>
