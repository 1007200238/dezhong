...
<body>
	...
	<!-- 标题栏 -->
	<div class="main-title"> <h2>采购计划单详情</h2></div>
	<div class="cf">
		<div class="fl">
			<a class="btn" href="<?php echo U('Psi/apply_info');?>&id=<?php echo I('get.id');?>&print=1" target="_blank" >打印单据</a>
			<span style="font-weight:bold;">申购部门：</span>
            <?php echo ($_list["department"]); ?>&nbsp;&nbsp;&nbsp;
