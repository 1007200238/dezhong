...
<body>
	...
	<div class="cf">
		<div class="fl">
            <button class="btn ajax-post confirm" url="<?php echo U('Psi/account_del');?>" target-form="ids">批量删除</button>
        </div>
		...
		<div class="search-form fr cf">
			<div class="sleft">
				...
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Psi/account');?>"><i class="btn-search"></i></a>
			</div>
	    ...
	    <tbody>
			<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
	            ...
	            <td><a href="<?php echo U('Psi/supplier_info');?>&id=<?php echo ($vo["supplier_id"]); ?>"><?php echo ($vo["company"]); ?></a></td>
				<td><?php echo (date("Y-m-d",$vo["date"])); ?></td>
				<td><?php echo ($vo["debit"]); ?></td>
				<td><?php echo ($vo["credit"]); ?></td>
				<td><?php echo ($vo["balance"]); ?></td>
				<td><?php echo ($vo["intro"]); if(empty($vo["intro"])): ?>——<?php endif; ?></td>
				<td><a href="<?php echo U('Psi/account_info');?>&id=<?php echo ($vo["id"]); ?>">记录详情</a></td>
